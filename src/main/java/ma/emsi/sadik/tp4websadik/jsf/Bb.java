package ma.emsi.sadik.tp4websadik.jsf;
...
import ma.emsi.sadik.tp4websadik.llm.LlmClient;
        ...
        if (question == null || question.isBlank()) {
            facesContext.addMessage(null,
                    new FacesMessage(FacesMessage.SEVERITY_ERROR,
                            "Question vide", "Veuillez saisir une question."));
            return null;
        }

        try {
            // Première question : fixer le rôle système
            ...
            facesContext.addMessage(null, new FacesMessage(
                    ...
                    "Erreur API LLM",
                    "Impossible de contacter Gemini : " + e.getMessage()
            ));
            return null;
        }
